        ...
        sendSticker: {
            async value(jid, path, quoted, options = {}) {
                ...
                if (options.packname || options.author) {
                    // Gunakan hanya yang tersedia di options, tanpa fallback ke global
                    exif = {
                        packName: options.packname || '',
                        packPublish: options.author || ''
                    };
                } else {
                    // Jika tidak ada options sama sekali, gunakan default global
                    exif = {
                ...
                let sticker = await writeExif({ mimetype: mime, data }, exif);
